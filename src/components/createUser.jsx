...
export default function CreateUser({ setShowPopUp }) {
  return (
    <>
      ...
      <div className='fixed z-20 inset-0 flex justify-center items-center'>
        <div className='relative bg-white rounded-3xl shadow-lg sm:max-w-xl w-full mx-4 p-10'>
            ...
            <button className='absolute right-6 top-6 p-2 hover:bg-gray-100 rounded-full transition-colors Z-60' onClick={() => setShowPopUp(false)}>
              <X
                size={30}
